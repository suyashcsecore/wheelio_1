...
const MyBookings = () => {
  ...
  useEffect(() => {
    user && fetchMyBookings() // whenever the user is logged in then only call this fetchMyBookings function
  }, [user]) // whenever the user changes, it will again call this function
