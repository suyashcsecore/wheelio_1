...
const Testimonial = () => {
    ...
    const testimonials = [
        { name: "Emma Rodriguez", 
          ...
          testimonial: "I've rented cars from various companies, but the experience with Wheelio was exceptional." 
        },
        { name: "John Smith", 
          location: "New York, USA",
          image: assets.testimonial_image_2,
          testimonial: "Wheelio made my trip so much easier. The car was delivered right to my door, and the customer service was fantastic!" 
        },
        { name: "Ava Johnson", 
          location: "Sydney, Australia",
          image: assets.testimonial_image_1,
          testimonial: "I highly recommend Wheelio! Their fleet is amazing, and I always fell like I'm getting the best deal with excellent service." 
        }
    ];
